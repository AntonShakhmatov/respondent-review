...
use App\Model\HardModel;
use App\Model\GptModel;
use Nette\Application\UI\Form;
use Nette\Database\Explorer;
use Nette\Utils\DateTime;

class HardPresenter extends \Nette\Application\UI\Presenter
{
    private $model;
    private $request;
    private $database;
    ...
    public function __construct(HardModel $model, Request $request, Explorer $database, AnswerModel $answer, GptModel $gpt_check)
    {
        parent::__construct();
        $this->model = $model;
