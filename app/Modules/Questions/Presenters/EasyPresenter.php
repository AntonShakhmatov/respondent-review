...
class EasyPresenter extends \Nette\Application\UI\Presenter
{
    private $model;
    private $request;
    private $database;
    ...
    public function __construct(EasyModel $model, Request $request, Explorer $database, AnswerModel $answer, GptModel $gpt_check)
    {
        parent::__construct();
        $this->model = $model;
